...
var LanguageProvider = function LanguageProvider(props) {
  ...
  var russianLanguage = {
    ...
    cart: {
      ...
      submit: 'Отправить',
      information: 'После отправки заказ, мы с Вами свяжемся для того, чтобы утверждать адрес доставки, Ваш заказ, и способ оплаты. '
    },
    confirmation: {
...
//# sourceMappingURL=shipping.js.7a6c95d08c42ba738bc0.hot-update.js.map