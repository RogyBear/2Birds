...
var LanguageProvider = function LanguageProvider(props) {
  ...
  var russianLanguage = {
    ...
    cart: {
      ...
      submit: 'Отправить',
      information: 'После отправки заказа, мы с Вами свяжемся для подтверждения заказа, утверждать адрес доставки, Ваш заказ, и способ оплаты. '
    },
    confirmation: {
...
//# sourceMappingURL=shipping.js.a0b5b4c46fe2c1b4b83f.hot-update.js.map