...
var LanguageProvider = function LanguageProvider(props) {
  ...
  var russianLanguage = {
    ...
    cart: {
      ...
      submit: 'Отправить',
      information: 'После отправки заказа, мы с Вами свяжемся для подтверждения  утверждать адрес доставки, Ваш заказ, и способ оплаты. '
    },
    confirmation: {
...
//# sourceMappingURL=shipping.js.9ea69827a87c63dfc8c9.hot-update.js.map