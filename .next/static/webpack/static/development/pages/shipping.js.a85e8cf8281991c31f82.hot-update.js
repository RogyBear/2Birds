...
var LanguageProvider = function LanguageProvider(props) {
  ...
  var russianLanguage = {
    ...
    cart: {
      ...
      submit: 'Отправить',
      information: 'После заказ, мы с Вами свяжемся для того, чтобы утверждать адрес доставки, Ваш заказ, и способ оплаты. '
    },
    confirmation: {
...
//# sourceMappingURL=shipping.js.a85e8cf8281991c31f82.hot-update.js.map