...
var LanguageProvider = function LanguageProvider(props) {
  ...
  var russianLanguage = {
    ...
    cart: {
      ...
      submit: 'Отправить',
      information: 'После того, как Вы отправили Ваш заказ, мы с Вами свяжемся для того, чтобы утверждать адрес доставки, Ващ заказAfter you have submitted your order, we will be in contact with you to confirm your shipping address, order, and payment method.'
    },
    confirmation: {
...
//# sourceMappingURL=shipping.js.7d16e9d19816de18c112.hot-update.js.map