...
var LanguageProvider = function LanguageProvider(props) {
  ...
  var russianLanguage = {
    ...
    cart: {
      ...
      submit: 'Отправить',
      information: 'После того, как Вы отправили Ваш заказ, мы с Вами свяжемся для того, чтобы утверждать адрес доставки, After you have submitted your order, we will be in contact with you to confirm your shipping address, order, and payment method.'
    },
    confirmation: {
...
//# sourceMappingURL=shipping.js.809136887207a0145f7c.hot-update.js.map