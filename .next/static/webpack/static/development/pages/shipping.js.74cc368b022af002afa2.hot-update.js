...
var LanguageProvider = function LanguageProvider(props) {
  ...
  var russianLanguage = {
    ...
    cart: {
      ...
      submit: 'Отправить',
      information: 'После того, как Вы отправили Ваш заказ, мы с Вами свяжемся для того, чтобы утверждать адрес доставки, Ваш заказ, и способ оплатыAfter you have submitted your order, we will be in contact with you to confirm your shipping address, order, and payment method.'
    },
    confirmation: {
...
//# sourceMappingURL=shipping.js.74cc368b022af002afa2.hot-update.js.map